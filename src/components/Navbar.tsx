    ...
    <nav className="bg-blue-900">
     <div className="flex items-center justify-center container mx-auto px-4 space-x-4">
        <div className="flex items-center justify-center h-16">
          <div className="flex items-center cursor-pointer group hover:scale-105 transition-transform" onClick={() =>  navigate("/")}>
        ...
        <div className="flex justify-center mt-4">
          <button className="bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 transition-colors" onClick={() =>  navigate("/register")}>
            Go to Register
          </button>
        </div>
      </div>
